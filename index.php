...
<head>
    ...
    <title>Barangay Commonwealth Community Policing and Surveillance</title>
    ...
    <section class="services" id="services">
        <div class="container">
            <div class="section-title">
                <h2>Our Services</h2>
                <p>Comprehensive community policing and surveillance services for the Barangay Commonwealth community</p>
            </div>
