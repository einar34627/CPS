...
<head>
    ...
    <title>Login - Community Policing and Surveillance</title>
    <link rel="icon" type="image/png" href="../assets/images/logo.png">
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.0.0-beta3/css/all.min.css">
    <link href="https://fonts.googleapis.com/css2?family=Inter:wght@300;400;500;600;700&display=swap" rel="stylesheet">
    <link rel="icon" type="img" href="img/cpas-logo.png">
    <style>
        * {
            margin: 0;
            padding: 0;
        ...
        :root {
            ...
            --secondary-color: #ff8effff;
            --secondary-dark: #ff6bf3ff;
...
<body>
    ...
    <img src="../img/cpas-logo.png" alt="Community Policing and Surveillance Watermark" class="watermark-logo">
    ...
    <div class="logo-left">
        <img src="../img/cpas-logo.png" alt="Community Policing and Surveillance Logo">
        <h1>Community and Surveillance</h1>
        <p class="tagline"> </p>
    ...
    <div class="login-container">
        <div class="login-logo">
            <img src="../img/cpas-logo.png" alt="Community Policing and Surveillance">
        </div>
        
        <div class="login-header">
            <h2>Login to Your Account</h2>
            <p>Access your Community Policing and Surveillance dashboard</p>
        </div>
